      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <div className="space-y-2">
            <h3
              id={titleId}
              className="text-xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight"
            >
              {title}
            </h3>
            <div
              id={descriptionId}
              className="text-sm font-medium text-neutral-500 dark:text-neutral-400 leading-relaxed"
            >
              {message}
            </div>
          </div>
          ...
          <div className="flex gap-3 w-full mt-2">
            ...
            <button
              ...
              onClick={onConfirm}
              disabled={isPending}
              className={`flex-1 px-4 py-2.5 font-bold rounded-xl border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 active:translate-y-0 active:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all duration-200 ${
                isDangerous ? "bg-rose-600 text-white" : "bg-indigo-600 text-white"
              }`}
            >
