...
export const AuthSetupChoice: React.FC = () => {
  ...
  if (authLoading || authEnabled === null || !authOnboardingRequired) {
    if (authStatusError) {
      return (
        <AuthStatusErrorPanel message={authStatusError} onRetry={retryAuthStatus} fullScreen />
      );
    }
    return (
            ...
            <>
              ...
              {isMigrationMode && (
                <div className="mb-6 rounded-lg border border-blue-200 dark:border-blue-900 bg-blue-50 dark:bg-blue-900/20 p-4 text-sm text-blue-800 dark:text-blue-200">
                  ExcaliDash v0.4 adds multi-user and OIDC support. Enabling authentication secures
                  upgraded instances before sharing access.
                </div>
              )}
            ...
            <>
              <div className="mb-6 rounded-lg border border-rose-200 dark:border-rose-900 bg-rose-50 dark:bg-rose-900/20 p-4 text-sm text-rose-800 dark:text-rose-200">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    With authentication disabled, anyone who can access this instance can use all
                    data and settings. They can also enable authentication themselves and lock you
                    out.
                  </div>
                </div>
              </div>
