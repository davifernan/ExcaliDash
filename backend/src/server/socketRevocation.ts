...
export const registerApiKeySocketRevoker = (revoker: ApiKeySocketRevoker): void => {
  revokeSockets = revoker;
};

export const disconnectApiKeySockets = (apiKeyId: string): Promise<void> => revokeSockets(apiKeyId);

export const registerUserSocketRechecker = (rechecker: UserSocketRechecker): void => {
