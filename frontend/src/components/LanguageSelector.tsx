 ...
 */
export const LanguageSelector: React.FC<LanguageSelectorProps> = ({ langCode, onChange }) => {
  const { t } = useI18n();
  ...
  return (
    ...
    >
      <span style={{ fontSize: 13, flexShrink: 0 }}>{t("labels.language", null, "Language")}</span>
      <select
        value={langCode}
